  ...
  return (
    <>
      ...
      {readyToHire && !hireClicked && (
        <div className="fixed bottom-16 md:bottom-4 right-4 z-50 animate-[slideIn_0.5s_ease-out]">
          <button
      ...
      <button
        ...
        className="fixed bottom-16 md:bottom-4 left-4 z-50 flex items-center gap-2 px-3 py-2 bg-card border border-border rounded-full shadow-lg hover:border-accent transition-all"
      >
      ...
      {open && (
        <>
          ...
          <div className="fixed bottom-28 md:bottom-16 left-4 z-50 w-72 max-h-[70vh] bg-card border border-border rounded-xl shadow-xl overflow-hidden">
            {/* Header */}
