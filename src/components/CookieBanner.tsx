...
export default function CookieBanner({ gaId }: { gaId?: string }) {
  ...
  return (
    <div className="fixed bottom-28 md:bottom-4 left-4 right-4 sm:left-auto sm:right-4 sm:max-w-sm z-[60] bg-card border border-border rounded-xl p-4 shadow-xl">
